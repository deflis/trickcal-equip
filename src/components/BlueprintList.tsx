  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <div className="flex items-center bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
            <button onClick={() => onUpdate(bp.id, -1)} className="p-1.5 text-slate-400 hover:text-indigo-600 hover:bg-slate-50 transition-colors">
            ...
            <input
              ...
              className="w-10 text-center font-bold text-sm text-indigo-600 focus:outline-none bg-transparent [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
            />
            <button onClick={() => onUpdate(bp.id, 1)} className="p-1.5 text-indigo-500 hover:text-indigo-700 hover:bg-slate-50 transition-colors">
      ...
      <div className="flex items-center gap-2 mt-2 pt-2 border-t border-slate-100">
        <span className="text-[10px] text-slate-400 font-medium shrink-0">所持</span>
        <div className="flex items-center bg-white rounded-md border border-slate-200 overflow-hidden">
          <button onClick={() => onUpdateHolding(bp.id, -1)} className="p-1 text-slate-400 hover:text-slate-600 hover:bg-slate-50 transition-colors">
          ...
          <input
            ...
            className="w-9 text-center font-bold text-xs text-slate-600 focus:outline-none bg-transparent [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
          />
          <button onClick={() => onUpdateHolding(bp.id, 1)} className="p-1 text-slate-500 hover:text-slate-700 hover:bg-slate-50 transition-colors">
        ...
        {req > 0 && (
          <>
            <span className="text-[10px] text-slate-400 ml-auto shrink-0">不足</span>
            <span className={`text-sm font-black ${shortage > 0 ? 'text-orange-500' : 'text-green-500'}`}>
              {shortage}
            </span>
          </>
        )}
